...
export default function VerifyEmail() {
  ...
  useEffect(() => {
    ...
    const verifyEmail = async () => {
      ...
      try {
        // Verify email using mock API
        const res = await mockAPI.auth.verifyEmail(token);

        // For mock, we'll just show success without tokens
        // In a real app, you would store tokens here
