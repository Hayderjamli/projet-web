      ...
      <section className="container pb-24">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          >
            ...
            <p className="text-muted-foreground">Get suggestions to improve clarity, impact, keyword alignment, and ATS score.</p>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <motion.div
            ...
            className="rounded-2xl p-6 bg-card border border-primary/20 shadow-md hover:shadow-xl transition-all"
          >
            <h4 className="font-semibold text-card-foreground mb-2">Skills Gap Analyzer</h4>
            <p className="text-muted-foreground">Identify and close skill gaps for your target roles.</p>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            ...
            className="rounded-2xl p-6 bg-card border border-primary/20 shadow-md hover:shadow-xl transition-all"
          >
            <h4 className="font-semibold text-card-foreground mb-2">Dashboard & Analytics</h4>
            <p className="text-muted-foreground">Track your progress, review session history, and view performance analytics.</p>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
